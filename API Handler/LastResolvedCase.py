...
#    print(f"Epoch Now: {epoch_now}, Epoch 24h Ago: {epoch_24h_ago}")
    ...
    url = urlunparse(("https", HOST, f"/connect/api/v1/cases?tenant_id=<tenentID or custID>?min_score=50&status=Resolved&sort=created_at&order=desc&limit=5", "", "", ""))
...
#    print("------------ call result of /connect/api/v1/cases -------------")
    if 'data' in cases and cases['data']['total'] > 0:
        ...
        print("Tidak ada data yang ditemukan dalam rentang waktu yang ditentukan.")
